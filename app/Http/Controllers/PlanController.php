...
class PlanController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated_data = $request->validate([
            ...
            'code' => 'required|regex:/^[A-Z]{3}-\d{3}$/|string|unique:plans,code,',
        ...
        return redirect()->route('plan.index')->with('success', 'Plan had been created');
    ...
    public function update(Request $request, Plan $plan)
    {
        ...
        return redirect()->route('plan.index')->with('success', 'Plan hs been updated');
    }
