                    ...
                    <form action="{{ route('plan.store') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="term" id="term" class="select select-bordered w-full">
                                <option value="monthly" @selected(old('term') == 'monthly')>Monthly
                                </option>
                                <option value="yearly" @selected(old('term') == 'yearly')>Yearly
                                </option>
                                <option value="lifetime" @selected(old('term') == 'lifetime')>Lifetime
                                </option>
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="membership_fee" name="membership_fee" type="text"
                                    class="mt-1 block w-full" :value="old('membership_fee', '')" required
                                    autocomplete="off" />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="currency" name="currency" type="text" class="mt-1 block w-full"
                                    :value="old('currency', '')" required autocomplete="off" />
