                    ...
                    <form action="{{ route('plan.update', $plan->id) }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="code" name="code" type="text" class="mt-1 block w-full"
                                :value="old('code', $plan->code)" required autocomplete="off" />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="textarea textarea-bordered w-full h-32"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="term" id="term" class="select select-bordered w-full">
                                <option value="monthly" @selected(old('term', $plan->term) == 'monthly')>Monthly</option>

                                <option value="yearly" @selected(old('term', $plan->term) == 'yearly')>Yearly</option>

                                <option value="lifetime" @selected(old('term', $plan->term) == 'yearly')>Lifetime
                                </option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="membership_fee" name="membership_fee" type="text"
                                class="mt-1 block w-full" :value="old('membership_fee', $plan->decimal_membership_fee)"
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="currency" name="currency" type="text" class="mt-1 block w-full"
                                :value="old('currency', $plan->currency)" required autocomplete="off" />
